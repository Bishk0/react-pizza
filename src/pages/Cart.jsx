...
import { addCartItem, clearCart, removeCartItem, subCartItem } from "../redux/actions/cart";
...
function Cart() {
  ...
  const onAddItem = id => dispatch(addCartItem(id));
  const onSubItem = id => dispatch(subCartItem(id));
