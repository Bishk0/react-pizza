...
function CartItem({ name, type, size, imageUrl, totalPrice, totalCount, id, onRemove, onAddItem, onSubItem }) {
  ...
  return (
    <div className="cart__item">
      ...
      <div className="cart__item-count">
        <div className="button button--outline button--circle cart__item-count-minus" onClick={handleSubClick}>
